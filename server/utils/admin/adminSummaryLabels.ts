...
const summaryLabelsEs = {
  ...
  newsletterUntitled: 'Campaña sin asunto',
  newsletterStatusDraft: 'Borrador',
  newsletterStatusQueued: 'En cola',
  newsletterStatusSending: 'Enviándose ahora',
  newsletterStatusSent: 'Enviada',
  newsletterStatusPaused: 'Pausada',
  newsletterStatusFailed: 'Enviada con incidencias',
...
export const SUMMARY_LABELS: Record<SummaryLocale, Record<string, string>> = {
  ...
  en: {
    ...
    newsletterUntitled: 'Campaign with no subject',
    newsletterStatusDraft: 'Draft',
    newsletterStatusQueued: 'Queued',
    newsletterStatusSending: 'Sending now',
    newsletterStatusSent: 'Sent',
    newsletterStatusPaused: 'Paused',
    newsletterStatusFailed: 'Sent with incidents',
  ...
  ca: {
    ...
    newsletterUntitled: 'Campanya sense assumpte',
    newsletterStatusDraft: 'Esborrany',
    newsletterStatusQueued: 'En cua',
    newsletterStatusSending: "S'està enviant",
    newsletterStatusSent: 'Enviada',
    newsletterStatusPaused: 'En pausa',
    newsletterStatusFailed: 'Enviada amb incidències',
  ...
  eu: {
    ...
    newsletterUntitled: 'Gairik gabeko kanpaina',
    newsletterStatusDraft: 'Zirriborroa',
    newsletterStatusQueued: 'Ilaran',
    newsletterStatusSending: 'Bidaltzen',
    newsletterStatusSent: 'Bidalita',
    newsletterStatusPaused: 'Etenda',
    newsletterStatusFailed: 'Bidalita gorabeherekin',
  ...
  gl: {
    ...
    equalityActive: 'Documento activo',
    equalityInactive: 'Documento inactivo',
    newsletterUntitled: 'Campaña sen asunto',
    newsletterStatusDraft: 'Borrador',
    newsletterStatusQueued: 'En cola',
    newsletterStatusSending: 'Enviándose agora',
    newsletterStatusSent: 'Enviada',
    newsletterStatusPaused: 'Pausada',
    newsletterStatusFailed: 'Enviada con incidencias',
...
/** Campaign status → summary label key. Kept beside the labels so the two cannot drift. */
export const NEWSLETTER_CAMPAIGN_STATUS_LABEL_KEYS = {
  draft: 'newsletterStatusDraft',
  queued: 'newsletterStatusQueued',
  sending: 'newsletterStatusSending',
  sent: 'newsletterStatusSent',
  paused: 'newsletterStatusPaused',
  failed: 'newsletterStatusFailed',
} as const
