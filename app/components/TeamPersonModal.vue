...
<template>
  <div class="detail-modal-shell bg-default relative px-5 pb-6 sm:px-8 sm:pb-8">
    ...
    <!-- Sticky header band: keeps the role label and the close button reachable while the body
    ...
    >
      <p
        ...
        class="text-primary min-w-0 truncate text-sm font-semibold sm:text-base"
      >
        {{ member.denomination }}
      </p>
    ...
    <div class="relative">
      <div class="relative grid gap-6 lg:grid-cols-[minmax(0,1fr)_220px] lg:gap-8">
        <div class="space-y-5">
          <div class="space-y-4">
            <div>
              <h2 class="max-w-3xl text-3xl leading-tight font-semibold sm:text-4xl">
                {{ displayName }}
              </h2>
            </div>
