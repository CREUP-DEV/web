...
<template>
  <div
    class="relative h-full w-full items-center justify-center bg-white p-10 text-neutral-900 lg:p-15 dark:bg-neutral-900 dark:text-neutral-50"
  >
    <div
    ...
    <div class="relative w-full flex-col items-center justify-center gap-5 text-center lg:gap-8">
      ...
      <h1
        class="m-0 w-full max-w-175 justify-center text-center text-[48px] leading-tight font-bold lg:max-w-250 lg:text-[80px]"
      ...
      <p
        v-if="description"
        class="max-w-162.5 text-[24px] leading-relaxed opacity-70 lg:max-w-225 lg:text-[32px]"
